...
namespace MauiApp1.Services
{
    public class QServer
    {
        ...
        public async Task<T> GET<T>(string url)
        {
            ...
            T responseItem = await Task.Run(() => JsonSerializer.Deserialize<T>(body, GetDefaultConvertSetting()));
        ...
        public async Task<string> Post(string path, object data)
        {
            ...
            if (data != null)
            {
                _data = JsonSerializer.Serialize(data, GetDefaultConvertSetting());
        ...
        public async Task<T> Post<T>(string path, object data)
        {
            ...
            T obj = JsonSerializer.Deserialize<T>(jsonText, GetDefaultConvertSetting());
            return obj;
        }
        ...
        JsonSerializerOptions GetDefaultConvertSetting()
        {
